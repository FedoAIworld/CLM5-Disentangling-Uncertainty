...
def perturb_soil_textures_and_parameters(iensemble=0):
    ...
    sname = ("/home/fernand/JUWELS/CLM5_DATA/inputdata/lnd/clm2/surfdata_map/trial_67890/FI-Hyy/" +
             "ensemble/" +"surfdata_FI-Hyy_hist_78pfts_CMIP6_simyr2000_c220825.nc_" +  
             str(iensemble + 1).zfill(5) + ".nc")
    sorig = ("/home/fernand/JUWELS/CLM5_DATA/inputdata/lnd/clm2/surfdata_map/trial_67890/FI-Hyy/ensemble/" +"surfdata_FI-Hyy_hist_78pfts_CMIP6_simyr2000_c220825.nc")
 ...
 #                   for t in range(dim_types):
        ...
        back_transformed_sucsat      = np.clip(np.power(10, perturbed_log_sucsat), 0, 800)
...
rnd_state_file = "soil_rnd_state_eclm.json"
force_seed = False 
