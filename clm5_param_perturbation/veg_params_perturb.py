...
def generate_vname(ensemble_number):
    base_path = "/home/fernand/JURECA/CLM5_DATA/inputdata/lnd/clm2/paramdata/ensemble/trial_54321/DE-HoH"
...
def perturb_vegetation_parameters(iensemble, parameter_ranges):
    vorig = "/home/fernand/JURECA/CLM5_DATA/inputdata/lnd/clm2/paramdata/ensemble/trial_54321/DE-HoH/clm5_params.c171117.nc"
...
def main():
    ...
    parameter_ranges = {
        ...
        #'leaf_long':       (2.64, 3.96),
        #'FUN_fracfixers':  (0, 1),
        'krmax':           (6.90E-11, 1.60E-10),
        'kmax':            (1.20E-08, 2.20E-07),
        #'fff':             (0.02, 5),
        'psi50':           (-189000.0, -351000.0),
        #'rhosnir':         (0.424, 0.636),
        #'rholnir':         (0.31, 0.51),
        #'taulnir':         (0.23, 0.53)
    }
